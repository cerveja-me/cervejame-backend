...
where z.active =true
 ...
 -- and z.id ='499dfe43-7712-438d-85bf-888b98c7c717' -- Ponta Grossa
  ...
  and s.createdat - interval 4 HOUR>'2017-07' and
  s.createdat - interval 4 HOUR < '2017-08'
  order by s.createdat;
  
  -- Resumo Vendas do mes anterior
select count(*) as 'vendas', sum(s.amount) 'unidades', sum(s.value) 'valor total', count(s.voucher is not null)
...
where z.active =true
 ...
 -- and z.id ='499dfe43-7712-438d-85bf-888b98c7c717' -- Ponta Grossa
  -- and z.id ='cc90e83f-124b-4ecb-95cf-3f39ca001c35' -- Dourados
  and s.createdat - interval 4 HOUR>'2017-07' and
  s.createdat - interval 4 HOUR < '2017-08-17'
  order by s.createdat;
