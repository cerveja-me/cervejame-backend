          ...
          Notifications.create(not)
            .then(function (result) {
              if (res[0].other === 'onesignal') {
                ...
                PushService.send(res[0].push_token, res[0].type, {
                  title: "Pedido Confirmado",
                  message: "Seu pedido foi aceito por um de nossos entregadores. Calma aí que tá chegando."
                });
              }
              callback(result);
            });
          ...
          Notifications.create(not)
            .then(function (result) {
              if (res[0].other === 'onesignal') {
                ...
                PushService.send(res[0].push_token, res[0].type, {
                  title: "Cerveja a caminho",
                  message: "Sua cerveja gelada já está a caminho. Fica esperto aí!"
                });
              }
              callback(result);
            });
          ...
          Notifications.create(not)
            .then(function (result) {
              if (res[0].other === 'onesignal') {
                ...
                PushService.send(res[0].push_token, res[0].type, {
                  title: "Cerveja entregue",
                  message: "Sua cerveja foi entregue. Foi tudo bem com seu pedido? Avalie a experiência da sua entrega."
                });
              }
              callback(result);
            });
