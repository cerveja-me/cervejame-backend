 ...
 */
 ...
 module.exports = {
  ...
  getOpenSales:function (req,res) {
    ...
    if(id){
      var query = "select s.aceptedAt - interval 3 hour as aceptedAt,s.createdat - interval 3 hour as createdAt, s.onWayAt - interval 3 hour as onWayAt,s.finishedAt - interval 3 hour as finishedAt, s.serviceRate as rate,"+
